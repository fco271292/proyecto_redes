...
<html>
    ...
    <body>
        ...
        <div id="show-house" class="content scaffold-show" role="main">
            ...
            <f:display bean="house" />
            <g:form resource="${this.house}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.house}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
